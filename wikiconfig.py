...
class LocalConfig(multiconfig.DefaultConfig):
    ...
    acl_rights_default = u"mathrho:read,write,delete,revert,admin"
    ...
    superuser = [u"mathrho", ]
    navi_bar = [u'Home', u'MyBlog', u'FrontPage', u'RecentChanges', u'FindPage', u'HelpContents', u'LanguageSetup']
